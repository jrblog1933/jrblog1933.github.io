...
class CreateElements{
  constructor(contenedor){ //recibe una lista de 3 nombres de contenedores grilla para las imagenes
    ...
    this.informacion = {
      reconocimientos: {
        ...
        "Me fue concedida en la plaza Bolivar de Porlamar en sesión solemne de la alcaldía del municipio Mariño con ocasión al <b> día del profesor jubilado </b>. <br><br> <a href='/html/discursos.html/#profesorJubilado' class='rounded-0 btn btn-primary bg-color-1 border border-white fw-bold'>Leer Discurso</a>",
  ...
  createAndInsertElements(){
    ...
    const archivos = [[9,"reconocimientos"],[9,"actosPublicos"],[11,"otros"]];
